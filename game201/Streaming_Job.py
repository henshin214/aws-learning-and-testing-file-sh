...
# S3 sink locations
output_path = args['s3_bucket'] + "/output/streaming/processed-data/"   # ATTENTION: DO NOT CHANGE THIS output_path
job_time_string = datetime.now().strftime("%Y%m%d%H%M%S")               # ATTENTION: DO NOT CHANGE THIS output_path
s3_target = output_path + 'data/' + job_time_string                     # ATTENTION: DO NOT CHANGE THIS output_path
checkpoint_location = output_path + "checkpoint/"
temp_path = output_path + "temp/"

country_lookup_path = args['s3_bucket'] + "/input/country_lookup/"
...
sourceData = glueContext.create_data_frame.from_catalog( \
    database = "gluejam_cloudformation", \
